...
行きの機内で入国申請書が配られるのでこれを記入しておく。これに備えて滞在先住所や連絡先など必要情報を事前にメモしておくと良い。
...
百度地图 (Baidu Map) が最も情報が充実しているが、英語非対応であり、非中国語話者にはちょっと使い難い。ストリートビューが使える点が強みで、現地の見た目を事前に調べておきたい場合には、頑張ってこのアプリを使うことになる。

Google Maps でも道や路線の情報は分かるし、外国人が書き込んだ情報が共有されているので、現実的にはそれで妥協することになるか。Apple の純正 Maps は更に情報が少なく使い物にならない印象。

### タクシー配車アプリ

滴滴 (DiDi) が有名だが、ドライバーとのコミュニケーションが必要とされるため、非中国語話者が使いこなすは難しいと思われる。慣れればなんとかなるのかもしれないが……

### 翻訳アプリ

一応 Google Translate をインストールしていったが、残念ながらあまり使い物にならなかった。他のアプリを模索する必要がある。
