...
- 連続オートフォーカスの追従性は絶望的。手ぶれ補正もまともな機能は無い。その辺りの、一般的な動画機に期待される機能はとことん不足している。
...
- Video Assist と外部 SDD を接続した BRAW ワークフローを導入することで化ける。動画機として使い勝手が格段に良くなる。コスパ的にも、本格的なシネマ向け機材を導入するのと比較すれば安い。
